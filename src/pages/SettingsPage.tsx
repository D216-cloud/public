...
import { Twitter, Trash2, Download, Upload, Camera, User, LogOut, CheckCircle, Crown } from "lucide-react"
          ...
          <TabsContent value="profile" className="space-y-4 sm:space-y-6">
            <Card className="hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden">
              <CardHeader className="px-4 sm:px-6 bg-gradient-to-r from-blue-50/80 to-purple-50/80 backdrop-blur-sm border-b border-gray-100/50">
                <CardTitle className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Profile Information</CardTitle>
                ...
                <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:space-x-8">
                  ...
                  <div className="flex flex-col items-center sm:items-start space-y-3">
                    <div className="text-center sm:text-left">
                      ...
                      <Badge variant="secondary" className="mt-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 border-0 px-3 py-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <Button variant="ghost" size="sm" className="text-red-600 h-9 px-4 hover:bg-red-50 rounded-lg transition-all duration-300" onClick={handleRemoveImage}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Receive notifications for likes, comments, and shares</p>
                    </div>
                    <Switch />
                  </div>
          ...
          <TabsContent value="automation" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your automation preferences</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Automatically post content to your Twitter account</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Select your timezone for optimal posting times</p>
                    </div>
                    <Select defaultValue="america-new-york">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Post content at optimal times for engagement</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Post content only on weekends</p>
                    </div>
                    <Switch />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Choose how often you receive invoices</p>
                    </div>
      ...
      <p className="text-sm text-muted-foreground">Receive email updates about your account activity</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Receive alerts when someone follows you</p>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Get notified when you're mentioned in posts</p>
                    </div>
                    <Switch 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Receive alerts for new direct messages</p>
                    </div>
                    <Switch 
                ...
                <div className="space-y-4 pt-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Receive notifications during weekends</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </div>
          ...
          <TabsContent value="automation" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure your content automation preferences</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Automatically post content to your social accounts</p>
                    </div>
                    <Switch 
                      checked={autoPosting.enabled}
                      onCheckedChange={(checked) => setAutoPosting({...autoPosting, enabled: checked})}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setAutoPosting({...autoPosting, timezone: value})}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch 
                      ...
                      onCheckedChange={(checked) => setAutoPosting({...autoPosting, optimalTimes: checked})}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Post content during weekends</p>
                    </div>
                    <Switch 
                      checked={autoPosting.weekendsOnly}
                      onCheckedChange={(checked) => setAutoPosting({...autoPosting, weekendsOnly: checked})}
                    />
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enhance your content before posting</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Automatically add relevant hashtags to posts</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Improve post quality with AI suggestions</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Automatically correct grammar and spelling</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </div>
                ...
                <div className="p-6 border rounded-lg bg-gradient-to-r from-blue-50 to-purple-50">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold">$29<span className="text-lg">/month</span></p>
                      <p className="text-sm text-muted-foreground">Next billing: June 15, 2023</p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-2xl font-bold my-2">$79<span className="text-base">/month</span></p>
                  ...
                  <div className="p-4 border-2 border-blue-500 rounded-lg relative">
                    ...
                    <p className="text-2xl font-bold my-2">$199<span className="text-base">/month</span></p>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    ...
                    <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600">Upgrade</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
