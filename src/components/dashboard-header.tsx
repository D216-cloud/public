  ...
  return (
    <>
            ...
            <div className="flex items-center space-x-3">
              ...
              <DropdownMenu open={isUserMenuOpen} onOpenChange={setIsUserMenuOpen}>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className="flex items-center space-x-3 p-3 rounded-xl border border-gray-200"
                    onClick={() => {
                  ...
                  >
                    <div className="flex items-center justify-center w-9 h-9 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full">
                ...
                >
                  ...
                  <div className="p-4 space-y-4 max-h-[400px] overflow-y-auto">
                    <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-200">
                      <div className="flex items-center space-x-3">
                        <div className="relative p-2.5 bg-blue-500 rounded-xl">
                          <Twitter className="h-5 w-5 text-white" />
                          <div className={`absolute -top-1 -right-1 w-3 h-3 rounded-full border-2 border-white ${twitterStatus.connected ? 'bg-green-500' : 'bg-gray-300'}`} />
                        </div>
                        <div>
                      ...
                      {twitterStatus.connected ? (
                        ...
                        <Badge className="text-xs border-gray-300 bg-gray-50 font-medium">Not Connected</Badge>
                      )}
                    </div>
                        ...
                        <div className="space-y-3">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-12 pr-4 py-3 text-sm font-medium text-gray-900 placeholder-gray-500 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              onKeyPress={(e) => {
                                if (e.key === 'Enter') {
              ...
              <Button
                variant="ghost"
                size="sm"
                className="md:hidden p-3 rounded-xl text-gray-700 hover:text-gray-900 hover:bg-gray-100"
                onClick={() => {
                  setIsUserMenuOpen(false)
      ...
      >
        ...
        <div 
          className={`
            absolute right-0 top-0 h-full w-80 max-w-full bg-white shadow-2xl border-l border-gray-200
        ...
        >
          ...
          <div className="py-6 space-y-2 px-4 max-h-[calc(100vh-6rem)] overflow-y-auto">
            ...
            <div className="px-4 py-4 bg-gray-50 rounded-xl border border-gray-200 mb-6">
              <div className="flex items-center space-x-3">
                <Avatar className="h-12 w-12">
                  <AvatarImage src={user?.profileImage || user?.profilePicture} />
                  <AvatarFallback className="bg-gradient-to-br from-blue-500 to-purple-600 text-white text-lg font-bold">
            ...
            <div className="space-y-1">
              ...
              {/* Logout Button */}
              <Button
                className="group relative flex items-center space-x-4 px-4 py-4 text-base font-semibold text-red-600 hover:text-red-700 bg-white border border-gray-200 rounded-xl transition-all duration-300 w-full text-left"
                variant="ghost"
                onClick={() => {
                  handleLogout()
                  setIsMobileMenuOpen(false)
